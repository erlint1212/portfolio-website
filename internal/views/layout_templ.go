...
func Base(title string, content templ.Component, currentPath string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 12, "<style>\n\t\t\t:root {\n\t\t\t\t--sidebar-w: 16rem;\n\t\t\t}\n\t\t\t@media (max-width: 767px) {\n\t\t\t\t:root {\n\t\t\t\t\t--sidebar-w: 0px;\n\t\t\t\t}\n\t\t\t}\n\n\t\t\t.grid-layout {\n\t\t\t\tdisplay: grid;\n\t\t\t\tgrid-template-columns: var(--sidebar-w) 1fr;\n\t\t\t\ttransition: grid-template-columns 300ms ease-in-out;\n\t\t\t\theight: 100vh;\n\t\t\t\toverflow: hidden;\n\t\t\t}\n\n\t\t\t/* overflow: visible so the absolutely-positioned button is not clipped */\n\t\t\t#sidebar-wrapper {\n\t\t\t\toverflow: visible;\n\t\t\t\tposition: relative;\n\t\t\t}\n\n\t\t\t#sidebar-arrow {\n\t\t\t\ttransition: transform 300ms ease-in-out;\n\t\t\t}\n\t\t</style></head><body class=\"overflow-hidden bg-white\"><div class=\"grid-layout w-full max-w-[1600px] mx-auto border-x border-gray-200 shadow-sm\"><div id=\"sidebar-wrapper\"><button id=\"sidebar-toggle\" class=\"absolute top-4 z-50 flex items-center justify-center w-8 h-8 bg-white border border-gray-200 shadow-sm rounded-md hover:bg-gray-50 focus:outline-none\" style=\"right: -2.5rem;\" title=\"Toggle Directory\"><svg id=\"sidebar-arrow\" class=\"w-5 h-5 text-gray-600\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M15 19l-7-7 7-7\"></path></svg></button><div class=\"w-64 h-full overflow-hidden bg-[#fbfcff] border-r border-gray-200 p-6 pt-14 flex flex-col\" id=\"sidebar-inner\"><div class=\"mb-10 block\"><div class=\"w-8 h-8 bg-black mb-4 flex-shrink-0\"></div><div><h1 class=\"text-sm font-bold tracking-tight\">Erling T. Nordtvedt</h1><p class=\"text-xs text-gray-500 font-mono mt-1\">MSc Data Science</p></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
